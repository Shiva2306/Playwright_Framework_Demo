...
- Name: TC_006_LoginDDT.spec.ts >> Login Test with CSV Data: invalid2 @datadriven
        ...
        - generic [ref=e87]:
          ...
          - generic [ref=e91]:
            - generic [ref=e92]:
              ...
              - textbox "E-Mail Address" [ref=e94]: qedge456@yahoo.com
            - generic [ref=e95]:
              - generic [ref=e96]: Password
              - textbox "Password" [ref=e97]: demo@456
